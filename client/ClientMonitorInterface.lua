...
function refreshDialTab(tabControl, addrBook)
	...
	for i, addr in pairs(addrBook) do
		local addressTable = azddressBook.stringToTable(addr.address)
...
function createDebugTab(tabControl)
	...
	chevronTable = debugTab
		...
		:addRow("Chevron 1", "Inactive")
		:addRow("Chevron 2", "Inactive")
		:addRow("Chevron 3", "Inactive")
		:addRow("Chevron 4", "Inactive")
		:addRow("Chevron 5", "Inactive")
		:addRow("Chevron 6", "Inactive")
		:addRow("Chevron 7", "Inactive")
		:addRow("Chevron 8", "Inactive")
		:addRow("Chevron 9", "Inactive")
end
